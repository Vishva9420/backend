...
for rendition in "${renditions[@]}"; do
  ...
  cmd+=" -hls_segment_filename images/${target}/${name}_%03d.ts images/${target}/${name}.m3u8"
...
echo -e "${master_playlist}" > images/${target}/playlist.m3u8

echo "Done - encoded HLS is at images/${target}/"
